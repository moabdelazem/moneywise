                ...
                <Card className="bg-gradient-to-br from-card/90 to-card/70 backdrop-blur-xl shadow-xl border-opacity-50">
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                        ...
                        <Button
                            ...
                            className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-blue-500/25"
                        >
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="space-y-1.5">
                                                    <h4 className="font-semibold tracking-tight">{reminder.title}</h4>
